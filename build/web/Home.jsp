    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <a href="loadbloghome" class="nav-item nav-link">Blogs</a>
                        ...
                        <div class="nav-item dropdown"">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <c:if test="${sessionScope.acc.role == 1}">
                                    <a href="LoadUserAccount" class="dropdown-item">Manage Accounts</a>
                                </c:if>
                                <c:if test="${sessionScope.acc.role == 3}">
                                    <a href="course-admin.jsp" class="dropdown-item">Manage Courses</a>
                                    <a href="managelesson" class="dropdown-item">Manage Lesson</a>
                                </c:if>
                                <c:if test="${sessionScope.acc.role == 4}">
                                    <a href="loadblog" class="dropdown-item">Manage Blogs</a>
                                </c:if>
        ...
        <div class="container-fluid px-0 py-5">
            ...
            <div class="row" style="margin: 0; padding: 0;">
                ...
                <c:forEach items="${requestScope.lst}" var="course" varStatus="count">
                    <div class="col-6 col-md-4" style="text-align: center; margin-bottom: 10px;">
                        <div class="card">
                            <img class="card-img-top img-fluid" src="${course.course_image}" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">${course.course_name}</h5>
                                <p class="card-text">${course.course_description}</p>
                                <a href="course-detail?courseId=${course.course_id}&user_gmail=${sessionScope.acc.usergmail}" class="btn btn-primary">Enroll</a>
                            </div>
                        </div>
                    </div>
                </c:forEach>
