                                    ...
                                    <div class="card-body p-md-5 mx-md-4" >
                                        <form action="SaveAccount" method="post">
                                            <div class="form-outline mb-4">
                                                <input value="${user.userName}" name="userNameChange" type="text" id="form2Example11" class="form-control"/>
                                            ...
                                            <div class="form-outline mb-4">
                                                <input value="${user.dob}" name="userDobChange" type="date" id="form2Example11" class="form-control" style="font-style: italic;font-weight: lighter;width: 500px"/>
                                                <label class="form-label" for="form2Example11" >Date of birth</label>
                                                <p class="text-danger">${messdob}</p>
                                            </div>
                                            <div class="form-outline mb-4">
                                                <input value="${user.userGmail}" name="userEmailChange" type="text" id="form2Example11" class="form-control" readonly="" style="font-style: italic;font-weight: lighter"/>
                                                <label class="form-label" for="form2Example11" >Email</label>
                                            </div>
                                            <div  class="form-outline mb-4">
                                                <input value="${user.phone}" name="userPhoneChange" type="text" id="form2Example22" class="form-control" pattern="(\+84|0)\d{9}" title="Ví dụ: 0987654321" />
                                                <label class="form-label" for="form2Example22">Phone Number</label>
                                                <p class="text-danger">${messphone}</p>
                                            </div>

                                            <div class="text-center pt-1 mb-5 pb-1" style="width: 100px;">
                                                <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit">SAVE</button>                                            
                                            </div>                                           
                                            <div class="text-center pt-1 mb-5 pb-1" style="width: 200px">
                                                <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="button"><a href="ChangePassword.jsp" style="color:white;text-decoration: none">CHANGE PASSWORD</a></button>                                            
                                            </div>     
                                        </form>
