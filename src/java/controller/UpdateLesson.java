...
public class UpdateLesson extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String lessonID = request.getParameter("sid");
            LessonDAO dao = new LessonDAO();
            Lesson l = dao.getLessonByID(lessonID);
            request.setAttribute("ul", l);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String ldescription = request.getParameter("description");
        String lcid = request.getParameter("courseID");
        LessonDAO dao = new LessonDAO();
        dao.updateLesson(lid, lname, ldescription, lcid);
        response.sendRedirect("managelesson");
    }
