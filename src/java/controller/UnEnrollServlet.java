...
public class UnEnrollServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            String user_gmail = request.getParameter("user_gmail");
            int course_id = Integer.parseInt(request.getParameter("courseId"));
            
            EnrollDAO enroll = new EnrollDAO();
            enroll.UnEnroll(user_gmail, course_id);
            
            response.sendRedirect("course-enroll.jsp");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UnEnrollServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
