                ...
                <div class="navbar-nav mx-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="detail.jsp" class="dropdown-item">Foreign Language</a>
                            <a href="feature.jsp" class="dropdown-item">Mathematic</a>
                            <a href="team.jsp" class="dropdown-item">Engineering</a>
                            <a href="testimonial.jsp" class="dropdown-item">Business</a>
                            <a href="testimonial.jsp" class="dropdown-item">Others</a>
                        </div>
                    </div>
                    <a href="about.jsp" class="nav-item nav-link">My courses</a>
