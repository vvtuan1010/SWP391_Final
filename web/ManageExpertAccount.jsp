...
<html lang="en">
    ...
    <body>
        ...
        <div  style="text-align: center" >
            ...
            <a   class='ManageTitle' style="color:#2878EB !important" href="LoadExpertAccount">Expert Account</a>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                ...
                <c:forEach begin="1" end="${numberPage}" var="i">
                    <li class="page-item"><a class="page-link" href="LoadExpertAccount?index=${i}">${i}</a></li>
                    </c:forEach>
                <li class="page-item">
